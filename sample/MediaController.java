...
public class MediaController extends FrameLayout {
	...
	private boolean isInit = true;//标记初始化进入
	...
	public MediaController(Context context, boolean fromXml, View container) {
		...
		// ����ط���FrameLayout.LayoutpParams����Ϊ�����ļ���Ҫ��MediaController����ͼ��ΪchildView�ӵ�һ��FrameLayout��ȥ
		FrameLayout.LayoutParams p = new FrameLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);// ����������MediaController�;���ķ������LayoutParams��
	...
	private void initControllerView(View v) {
		...
		mCurrentTime.setTypeface(fontFace);
		mEndTime.setTypeface(fontFace);
	...
	private long setProgress() {
		...
		if (mCurrentTime != null){
			...
			// add 5s pause
			if (Integer.valueOf(StringUtils.generateTime(position).split(":")[1])==5  ) {
				initPause();
			}
		}
